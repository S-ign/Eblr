...
const ContentToolbox = (props) => {
  ...
  return (
    <div className="flex w-fit bg-white rounded-sm p-5 gap-8">

      <div onClick={() => setShowModal(true)} className="flex flex-col hover:cursor-pointer">
        <div className="w-10 h-10">
          <svg id="managed-icon__posts-text" fill="var(--icon-color-primary, black)" viewBox="0 0 20.8 13">
      ...
      <div className="flex flex-col">
        <div className="w-10 h-10">
          <svg id="managed-icon__posts-photo" fill="var(--icon-color-primary, #FF4930)" viewBox="0 0 17 15">
      ...
      <div className="flex flex-col">
        <div className="w-10 h-10">
          <svg id="managed-icon__posts-quote" fill="var(--icon-color-primary, #FF8A00)" viewBox="0 0 17 13">
      ...
      <div className="w-10">
        <svg id="managed-icon__posts-link" fill="var(--icon-color-primary, #00CF35)" viewBox="0 0 17 17">
      ...
      <div className="flex flex-col">
        <div className="w-10 h-10">
          <svg id="managed-icon__posts-chat" fill="var(--icon-color-primary, #00B8FF)" viewBox="0 0 18.7 17">
      ...
      <div className="flex flex-col">
        <div className="w-10 h-10">
          <svg id="managed-icon__posts-audio" fill="var(--icon-color-primary, #7C5CFF)" viewBox="0 0 19 16">
      ...
      <div className="flex flex-col">
        <div className="w-10 h-10">
          <svg id="managed-icon__posts-video" fill="var(--icon-color-primary, #FF62CE)" viewBox="0 0 16 15">
